...
const Footer = () => {
    return (
        <div className='w-full h-[135vh] bg-[#061B09] relative overflow-y-hidden'>
            <div className='w-[92%] h-[75vh] flex gap-33 text-white/90 justify-center pt-17'>
                <ul className='inter flex flex-col gap-3'>
            ...
            <div className='w-full h-[25vh] pr-15 pl-15 text-xs text-white/90 pt-4'>
