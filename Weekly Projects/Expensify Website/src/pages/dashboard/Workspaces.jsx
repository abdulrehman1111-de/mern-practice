  ...
  return (
    <div className={`graySelect text-white w-full h-full overflow-y-auto ${dark ? "bg-[#061B09]" : "bg-white"}`}>
      ...
      <div className='w-[25%] h-15 flex gap-0'>
        ...
        <Graybtn dark={dark} text="Domains" />
      </div>
      ...
      <div className='w-full h-[75vh] flex flex-col gap-2 justify-center items-center'>
        ...
        <div className='flex flex-col justify-center items-center gap-2'>
          <p className={`text-2xl ${dark ? "text-white" : "text-gray-900"}`}>Enhance your security with domains</p>
          <p className={dark ? "text-white/70" : "text-gray-500"}>Require members on your domain to log in via single sign-on, restrict workspace creation, and more.</p>
        </div>
