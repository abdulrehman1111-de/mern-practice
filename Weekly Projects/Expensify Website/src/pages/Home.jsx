...
const Home = ({dark}) => {
    ...
    return (
        <>
                    ...
                    <div className='homeDiv h-[127vh] w-[60%] flex flex-col gap-10'>
                        ...
                        <div className='w-full h-40 flex flex-col gap-3'>
                            ...
                            <div className='flex gap-3'>
                                <Card dark={dark} title="Organize my own expenses" />
                                <Card dark={dark} title="Manage expenses for 1-9 employees" />
                                <Card dark={dark} title="Manage expenses for 10+ employees" />
                            </div>
                        </div>
                         
                        <div className={`w-[90%] h-15 flex justify-center items-center rounded-4xl ${dark ? 'bg-white' : 'bg-green-400' }`}>
                            <input className={`w-full h-full rounded-full pl-5 ${dark ? "text-gray-600" : "text-white"}`} type="text" name="" id="" placeholder='Enter your email or phone number'/>
                            <div className={`z-100 ml-auto mr-1 w-[40%] h-13 rounded-4xl flex justify-center items-center text-center ${dark ? "bg-[#2FE38A] hover:bg-green-400" : "bg-white text-green-400 hover:bg-gray-100"}`}>
            ...
            <Firstcards dark={dark}/>

            <Paginationpage dark={dark}/>

            <div className={`w-full h-[100vh] pr-30 pl-30 ${dark ? "bg-[#1A3D32]" : "bg-white"}`}>
                <div className={`w-full h-[25vh] flex justify-center items-center ${dark ? "text-white" : "text-gray-900"}`}>
                ...
                <div className='w-full h-[55vh] flex justify-center items-center gap-7'>
                    <Testcards dark={dark} title="“The easiest expense tool I've ever used.”" desc="“It is very very easy, as soon as you get a receipt you can scan it, the AI will capture all relevant information and it is very little interaction to get to the final sumbmission.”" name="Luis F." icon="https://i.pinimg.com/originals/e3/7e/0e/e37e0e25686c2139b281a57a5b4906f2.jpg" />
                    <Testcards dark={dark} title="“Great Program!”" desc="“Expensify has a great UI interface and is very intuitive to use. I particularly like the funcitonality of taking a picture of a receipt and having it uploaded to my account. I also like that I can send an email.”" name="Kirsten H." icon="https://i.pinimg.com/originals/f4/9d/58/f49d58b8c6a678be1e4ff288b98cc75b.jpg" />
                    <Testcards dark={dark} title="“Simple, Straight-forward Expenses!”" desc="“I've never met someone that enjoys doing their expenses. Following business trips or in the office, take time out of their day/week to sort through, and enter receipts." name="Weston M." icon="https://img.magnific.com/free-photo/portrait-white-man-isolated_53876-40306.jpg" />
                </div>
                ...
                <div className='w-full h-20 flex justify-around items-center pl-15 pr-15 text-white pt-15'>
                    <div className='flex gap-2 w-auto pr-10 mr-auto'>
                        ...
                        <p className={`translate-y-0.5 ${dark ? "text-white" : "text-gray-700"}`}>4,200+ <b>5-star</b> reviews</p>
                    </div>
            ...
            <div className={`w-full h-[55vh] flex justify-center items-center ${dark ? "bg-[#1A3D32]" : "bg-gray-50"}`}>
                <div className={`w-[50%] h-[50vh] pl-15 pr-15 flex flex-col gap-5 justify-center items-center ${dark ? "text-white" : "text-gray-900"}`}>
                    <p className='fraunces text-4xl'>Ready to simplify your receipt and expense management process?</p>
                    <p className={`fraunces ${dark ? "text-white" : "text-gray-600"}`}>Enter your email or phone number to make your company's money go further with Expensify's time-saving spend management tools.</p>
                </div>
                <div className='w-[50%] h-[50vh] flex justify-center items-center gap-13 flex-col pl-10 pr-10'>
                    ...
                    <div className='flex gap-3 items-center relative bottom-3 mr-auto relative left-8'>
                        <span className= {dark ? "text-white" : "text-gray-600"}>Or get started with</span>
                        <Googlebtn />
                    </div>
                </div>
            </div>
