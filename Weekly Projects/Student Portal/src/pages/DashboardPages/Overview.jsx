...
import OverviewTimetable from '../../components/OverviewTimetable'
  ...
  return (
    <div className='bg-bg w-full min-h-screen p-8 inter'>
      ...
      <div className='flex gap-5'>
        ...
        <div className='w-[60%] h-[90vh] mt-5'>
          ...
          <div className='w-full h-[30%] mt-5 bg-panel rounded-xl p-4 flex flex-col justify-between'>
        ...
        <div className='w-[40%] h-[150vh] mt-5 flex flex-col gap-5'>
          ...
          <div className='p-5 w-full h-[24%] bg-panel border border-border rounded-xl'>
          ...
          <div className='p-5 w-full h-[25%] bg-panel border border-border rounded-xl'>
            <div className='flex justify-between'>
