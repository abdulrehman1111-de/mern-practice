    ...
    <div className='bg-bg w-full min-h-screen p-4 lg:p-8 inter'>
      ...
      <div className='settings'>
        ...
        <div className='flex flex-col mt-4'>
          <p className='text-xl lg:text-2xl text-text font-semibold space'>Settings</p>
          <p className='text-sm space text-text/60 inter'>Manage your account preferences.</p>
        </div>

        <div className='w-full h-auto p-4 lg:p-5 border border-border rounded-xl bg-panel mt-5'>
          ...
          <div className='w-full flex flex-col gap-5 mt-7'>
            ...
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-3 sm:gap-0'>
              ...
              <label className='relative w-15 h-8 block shrink-0' htmlFor="ball">
            ...
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-3 sm:gap-0'>
              ...
              <label className='relative w-15 h-8 block shrink-0' htmlFor="ball2">
            ...
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-3 sm:gap-0'>
              ...
              <label className='relative w-15 h-8 block shrink-0' htmlFor="ball3">
        ...
        <div className='w-full h-auto p-4 lg:p-5 border border-border rounded-xl bg-panel mt-5'>
          ...
          <div className='w-full flex flex-col gap-5 mt-7'>
            ...
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-3 sm:gap-0'>
              ...
              <button className='h-auto p-2 border-2 border-border/60 text-border rounded-lg self-start sm:self-auto'>
            ...
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-3 sm:gap-0'>
              ...
              <button className='h-auto p-2 border-2 border-danger/60 text-border rounded-lg self-start sm:self-auto'>
