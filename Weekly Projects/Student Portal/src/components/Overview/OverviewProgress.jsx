...
const OverviewProgress = ({subject, teacher, progress}) => {
  return (
    <div className='w-full p-2 h-auto flex flex-col lg:flex-row lg:justify-between gap-2 lg:gap-0'>
        ...
        <div className='flex gap-2 items-center'>
            ...
            <div className='h-1.5 w-full lg:w-40 bg-panel2 overflow-hidden rounded-full'>
