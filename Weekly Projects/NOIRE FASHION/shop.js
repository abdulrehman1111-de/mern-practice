        ...
        function createProductCard(product){
            return `
                <div class="mainCards pb-10">
                    ...
                    <div class="h-35 md:h-35 pt-5 pl-5 flex flex-col gap-2.5 cardSurface border-1 border-[rgba(19,17,20,0.14)] darkSurface">
                    ...
                    <div class="border-1 border-[rgba(19,17,20,0.14)] h-12 flex flex-row jetBrains text-sm">
                        <div class="w-[50%] cardSurface flex justify-center items-center darkSurface lightText view"><button>View</button></div>
