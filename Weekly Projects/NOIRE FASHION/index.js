    ...
    Array.from(container.children).forEach(card => {
        ...
        function createProductCard(product){
            return `
                <div class="mainCards pb-10">
                    <div class="cardSurface h-90 sm:h-110 md:h-103 bg-cover bg-center flex flex-row gap-60 sm:gap-110 md:gap-53 lg:gap-47 pt-4 pl-4 sm:pl-7 lg:pl-2" style = "background-image: url('${product.image}')">
        ...
        menu.addEventListener("click", ()=>{
            ...
            if (existingMenu){
                ...
                `
            <div class="menu hide fixed w-full h-200 z-300 top-0 bg-black absolute flex flex-col gap-3">
