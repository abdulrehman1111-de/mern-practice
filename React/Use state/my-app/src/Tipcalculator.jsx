    ...
    <div className='max-w-md mx-auto my-8 p-6 bg-slate-900 border border-slate-800 rounded-2xl shadow-xl flex flex-col gap-6 text-white font-sans'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div className='grid grid-cols-3 gap-2'>
          <button onClick={()=> setTipPercent(10)} className='p-3 text-sm font-semibold bg-slate-800 hover:bg-slate-700 active:scale-95 text-slate-200 rounded-xl border border-slate-700 transition-all'>Tip 10 percent</button>

          <button onClick={()=> setTipPercent(15)} className='p-3 text-sm font-semibold bg-slate-800 hover:bg-slate-700 active:scale-95 text-slate-200 rounded-xl border border-slate-700 transition-all'>Tip 15 percent</button>

          <button onClick={()=> setTipPercent(20)} className='p-3 text-sm font-semibold bg-slate-800 hover:bg-slate-700 active:scale-95 text-slate-200 rounded-xl border border-slate-700 transition-all'>Tip 20 percent</button>
        </div>
      </div>
